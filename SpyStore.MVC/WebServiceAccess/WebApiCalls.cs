...
namespace SpyStore.MVC.WebServiceAccess
{
    ...
    {
        public WebApiCalls(IWebServiceLocator settins) : base(settins) { }
        ...
        public async Task<string> AddToCartAsync(int customerId, int productId, int quantity)
        {
            ...
            // http://localhost:40001/api/shoppingcart/0 {"ProductId":22, "Quantity":2} Content-Type:application/json
        ...
        {
            // Remote Cart Item:
            // http://localhost:40001/api/shoppingcart/{customerId}/{id}/{TimeStampe} HTTPDelete
            // http://localhost:40001/api/shoppingcart/0/0/AAAAAAA1Uc = 
        ...
        public async Task<string> UpdateCartItemAsync(ShoppingCartRecord item)
        {
            ...
            // Note: Id, CustomerId, ProductId, TimeStampe, DateCreated, and Quanity in the body
            // {"Id":0, "CustomerId":0, "ProductId":32, "Quantity":2, "TimeStampe":"AAAAAAAA86s=", "DateCreated":"1/20/2016"}
