...
namespace SpyStore.MVC.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public CartController(IWebApiCalls webApiCalls)
        {
            ...
            {
                config.CreateMap<CartRecordViewModel, ShoppingCartRecord>();
                config.CreateMap<CartRecordWithProductInfo, CartRecordViewModel>();
                config.CreateMap<ProductAndCategoryBase, AddToCartViewModel>();
            });
        }
        ...
        [HttpGet("{productId}")]
        public async Task<IActionResult> AddToCart(int cusstomerId, int productId, bool cameFromProducts = false)
        {
